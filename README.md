#  DevState — Visual Finite State Machine  Automata Architect (Vue 3)
-------------------------------------------------------------------------------
...
*  **Vector Coordinate Math:** Dynamically calculates center-point SVG line connectors  between reactive node coordinates.
